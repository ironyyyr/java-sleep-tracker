...
public class CountSleeplessNightTest {
    ...
    private static CountSleeplessNight countSleepless;
    ...
    void setUp() {
        ...
        countSleepless = CountSleeplessNightImpl.countSleeplessNight();
    }

    @Test
    void getZeroSleeplessNight() {
        int correctQuantityOfSleeplessNight = 0;

        assertEquals(
                correctQuantityOfSleeplessNight,
                countSleepless.countSleeplessNight(sleepSessions),
                "Определение количества бессонных ночей работает некорректно " +
                        "\nожидаемое значение: " + correctQuantityOfSleeplessNight +
                        "\nимеем: " + countSleepless.countSleeplessNight(sleepSessions)
        );
    }
    ...
    void getOneSleeplessNight() {
        ...
        int correctQuantityOfSleeplessNight = 1;
